...
{
    public class LabResultWebsocketController : Controller
    {
        private readonly WebSocketHandler _webSocketHandler;
        private readonly IConsumer<string, string> _kafkaConsumer;

        public LabResultWebsocketController(WebSocketHandler webSocketHandler)
        {
            ...
            try
            {
                ...
                while (webSocket.State == WebSocketState.Open)
                {
                    ...
                    if (consumeResult.Message != null)
                    {
                        ...
                        var jsonObject = JsonConvert.DeserializeObject<LabResults>(jsonString);
